                ...
                <template x-if="wasFocused">
                    <div class="comm:mt-2">
                        <div class="comm:border-2 comm:border-dashed comm:border-gray-300 comm:dark:border-gray-600 comm:rounded-lg comm:p-4 comm:mb-2"
                            x-data="fileUpload()" x-on:click="$refs.fileInput.click()"
                            ...
                            <input type="file" x-ref="fileInput" x-on:change="handleFiles($event.target.files)"
                                multiple class="comm:hidden" accept=".jpg,.jpeg,.png,.gif,.pdf,.doc,.docx,.txt,.zip">

                            <div class="comm:text-center">
                                <svg class="comm:mx-auto comm:h-12 comm:w-12 comm:text-gray-400" stroke="currentColor"
                                ...
                                <p class="comm:mt-2 comm:text-sm comm:text-gray-600 comm:dark:text-gray-400">
                                    <span class="comm:font-medium comm:text-blue-600 comm:dark:text-blue-400">Click to
                                        upload</span>
                                    or drag and drop
                                </p>
                                <p class="comm:text-xs comm:text-gray-500 comm:dark:text-gray-500">PNG, JPG, PDF, DOC,
